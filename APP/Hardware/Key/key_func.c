...
static const KeyActionItem_T S_tKeyActionGlobal[] =
{
	...
	{KeyTriType_SysOnOffBuff,                  sizeof(KeyTriType_SysOnOffBuff),      KEY_MASK_ANY,    v_act_sys_on_off,        "开关机"},
};
...
{
	{KeyTriType_SysProteOnOffBuff,             sizeof(KeyTriType_SysProteOnOffBuff), KEY_MASK_NORMAL, v_act_sys_prote,         "系统充放保护"},

#if(boardDCAC_EN)
	{KeyTriType_AcOnOffBuff,                   sizeof(KeyTriType_AcOnOffBuff),       KEY_MASK_NORMAL, v_act_dcac_short,        "开关逆变"},
	{KeyTriType_AcOnOffBuff1,                  sizeof(KeyTriType_AcOnOffBuff1),      KEY_MASK_NORMAL, v_act_dcac_long,         "开关逆变1"},
	{KeyTriType_AcProteOnOffBuff,              sizeof(KeyTriType_AcProteOnOffBuff),  KEY_MASK_NORMAL, v_act_dcac_prote,        "开启逆变输入保护"},
#endif  //boardDCAC_EN

#if(boardDC_EN)
	{KeyTriType_DCOnOffBuff,                   sizeof(KeyTriType_DCOnOffBuff),       KEY_MASK_NORMAL, v_act_dc_switch,         "开关DC"},
	{KeyTriType_DCOnOffBuff1,                  sizeof(KeyTriType_DCOnOffBuff1),      KEY_MASK_NORMAL, v_act_dc_switch,         "开关DC"},
#endif  //boardDC_EN

#if(boardDISPLAY_EN)
	{KeyTriType_BLOnOffBuff,                   sizeof(KeyTriType_BLOnOffBuff),       KEY_MASK_NORMAL, v_act_backlight_switch,  "开关背光"},
	{KeyTriType_ForceOpenBLBuff1,              sizeof(KeyTriType_ForceOpenBLBuff1),  KEY_MASK_NORMAL, v_act_backlight_force_on,"强制开启背光"},
	{KeyTriType_ForceOpenBLBuff2,              sizeof(KeyTriType_ForceOpenBLBuff2),  KEY_MASK_NORMAL, v_act_backlight_force_on,"强制开启背光"},
#endif  //boardDISPLAY_EN
};
