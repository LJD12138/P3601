...
#define     	adcVBMS_R1                      		1020.0f //(Kohm)  分压的上电阻
#define     	adcVBMS_R2                      		39.0f  //(Kohm)  分压的对地电阻
...
typedef struct
{
	...
	vu16           		usUsbA_Volt;    	//0.1V
	float            	fUsbA_Curr;         //A
	
	vu16				usFanPwrVolt;     	//0.1V
}AdcSamp_T;
