...
/***********************************************************************************************************************
-----函数功能    从小端字节序数组中获取32位无符号整数
-----说明(备注)  将连续的4字节小端（Little-Endian）数据转换为32位无符号整数。
                data[0]为最低有效字节（LSB），data[3]为最高有效字节（MSB）。
-----传入参数    data: 指向4字节小端数据的指针（需保证至少4字节有效）
-----输出参数    none
-----返回值      转换后的32位无符号整数；若data为NULL则返回0
************************************************************************************************************************/
